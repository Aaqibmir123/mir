...
const Cart=(props)=>{
   const ctx=useContext(CartContext);
    ...
    async function data(items){
        let res=await
         axios.get(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}`);
   ...
   var quan=data[idx].quantity
     ...
     axios.put(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}/${idd}`,{...items,quantity:quan-1})
     ...
     ctx.removeItem(items)
      console.log('Deleted successfully')
         ...
         axios.delete(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}/${idd}`)
     .then(res=>{console.log('put crud crud ',res.data)
      ctx.removeItem(items)
     console.log('Deleted successfully')})
