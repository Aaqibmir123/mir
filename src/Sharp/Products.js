...
const Products = () => {
  ...
  async function Adddata(item) {
    ...
    const res =
      await axios.get(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}`);
    ...
    if (idx >= 0) {
      ...
      const res = await
        axios.put(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}/${id},{...obj,quantity:quan+1}`);
      ...
      const res = await
        axios.post(`https://crudcrud.com/api/7de0c0a490f042859adc363f0250ed42/cart${Formatedemail}`,obj);
      const data = await res.data;
      ctx.addItem(obj)
