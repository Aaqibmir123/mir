...
const Login = () => {
    ...
    const submit = (event) => {
        ...
        fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCfddi8_nogytvpSNkU1Ug2-q5QwbMLQCc', {
            method: "POST",
            body: JSON.stringify({
                email: email,
                password: password,
...
//when i logout the item remains visible the screen in react 